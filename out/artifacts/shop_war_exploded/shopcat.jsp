...
<script type="text/javascript">
		...
		function jian(id){
			...
			var newVlaue = value-1;
			if(value > 1){
				$("#count_"+id).val(newVlaue);
				var param = new Object();
				param.id = id;
				param.count = newVlaue;
					...
					<div class="bundle  bundle-last ">
						...
						<div class="bundle-main">
							...
							<ul class="item-content clearfix">
								...
								<li class="td td-amount">
									<div class="amount-wrapper ">
										<div class="item-amount ">
											<div class="sl">
												<input class="min am-btn" name="min" type="button" value="-" onclick="jian(${domain.id})" /> 
												<input class="text_box" id="count_${domain.id}" type="text" value="${domain.count}" style="width: 30px; text-align: center;" /> 
												<input class="add am-btn" name="add" type="button" value="+" onclick="add('${domain.goods_name1})'" />
											</div>
										</div>
									</div>
								</li>
								<li class="td td-sum">
									<div class="td-inner">
										<em tabindex="0" class="J_ItemSum number"><fmt:formatNumber value="${domain.count*domain.goods_price}" maxIntegerDigits="2"/></em>
									</div>
								</li>
								<li class="td td-op">
									<div class="td-inner">
			...
			<div class="float-bar-right">
				...
				<div class="price-sum">
					<span class="txt">合计:</span> <strong class="price"> ¥<em
						id="J_Total"></em><fmt:formatNumber value="${shoppingCart.price}" maxIntegerDigits="2"/>
					</strong>
				</div>
				<div class="btn-area">
					<a href="ShoppingServlet?action=pay" id="J_Go"
