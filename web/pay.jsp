...
// 							var dizhi = $("li[class='user-addresslist defaultAddr'] span[class='buy--address-detail']").html();
							...
							var shouhuoren = $(this).find("#idPerson").html();
							var dianhua = $(this).find("#idPhone").html();
							var dizhi = $(this).find("#idAddresss").html();
							
							console.info(shouhuoren);
							console.info(dianhua);
							console.info(dizhi);
							
							$("#buy_user").val(dianhua);
							$("#phone").val(dianhua);
							$("#address").val(dizhi);
...
// 				debugger
				$("#addDefId").attr("class","user-addresslist defaultAddr");
				$("#addDefId").find(".address-left").append("<ins class='deftip'>默认地址</ins>");
			})
	...
	<%@include file="head.jsp" %>
			<div class="concent">
				...
				<div class="paycont">
					...
					<c:forEach items="${addressList}" var="addre">
									<!-- 默认地址：class="user-addresslist defaultAddr" -->
									
										<li class="user-addresslist" id ="${addre.isdefault eq '是'? 'addDefId':'' }" >
											<div class="address-left">
												<div class="user DefaultAddr">
													 <span class="buy-address-detail"></span>
			                  						 <span >收货人</span>
													 <span class="buy-user" id ="idPerson">${addre.shouhuoren}</span>
												</div>
												<div class="phone DefaultAddr">
													 <span class="buy-address-detail"></span>
			                  						 <span>电话</span>
													 <span class="buy-phone" id = "idPhone">${addre.phone}</span>
												</div>
													
												<div class="default-address DefaultAddr">
													<span class="buy-line-title buy-line-title-type">收货地址：</span>
													<span class="buy--address-detail" id = "idAddresss">${addre.address}</span>
												</div>
<!-- 													<ins class="deftip">默认地址</ins> -->
					...
					<c:forEach items="${shoppingCart.list}" var="good">
							<!-- 购物车 -->
							<tr class="item-list">
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															...
															<div class="price-line"> 
																<em class="J_Price price-now" id="priceNow" tabindex="0">${good.goods_price_off}</em>
															</div>
														</div>
													</div>
												</li>
												...
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															...
															<input class="text_box" id="count" type="text" value="${good.count }" 
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number" id="singlePrice"><fmt:formatNumber value="${good.count*good.goods_price}" maxIntegerDigits="2"/></em>
												</div>
											</li>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee"><fmt:formatNumber value="${shoppingCart.price}" maxIntegerDigits="2"/></em>
											</span>
										</div>
									...
									<div id="holyshit269" class="submitOrder">
										...
										<form action="ShoppingServlet?action=submitOrder" method="post" id="form">
