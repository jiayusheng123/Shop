	...
	<div class="login-banner">
		<div class="login-main">
			...
			<div class="login-box">
				...
				<h3 class="title">登录商城管理</h3>

				<div class="clear"></div>

				<div class="login-form">
					<form  method="post" id ="login_from" Action="AdminServlet?action=login">
						<div class="user-name">
							<label ><i class="am-icon-user"></i></label> <input
								type="text" name="name" id="userName" placeholder="手机号登录">
						</div>
						<div class="user-pass">
